...
export const pb = fruit.pb;

export const FruitProtocol = fruit.FruitProtocol;

export const protoPlatform = fruit.com.cw.chess2.platform;

// const FRUIT_MODULE_TYPE = protoPlatform.ModuleType.fruit;
// const FRUIT_MODULE_TYPE = 123456789;
