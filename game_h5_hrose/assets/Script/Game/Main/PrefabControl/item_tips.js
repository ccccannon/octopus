...
cc.Class({
    ...
    properties: {
        ...
        animaType: {
            ...
            `,
            // get() {
            //     return this._animaType || ANIMATYPE.FADE_MOVEUP;
            // },
            set(val) {
                this._animaType = val;
            }
        ...
        tipsType: {
            ...
            tooltip: `
            NORMAL: 0,正常
            WITHANIMATION: 1,带入场动画
            `,
            // type:ANIMATYPE,
            default: ANIMATYPE.NORMAL,
            set(val) {
                this._tipsType = val;
            },
        },
    ...
    getShowText(code) {
        ...
        text = language[window.localLang].tips[code + ''];
    ...
    start() {
        // this.getAnimation();
        // this.scheduleOnce(this.tipsAnimation, 1);
    },
