...
$root.pb = (function() {
    ...
    pb.BestWinners = (function() {
         ...
         * @constructor
         * @param {pb.IBestWinners=} [properties] Properties to set
         */
         ...
         * @static
         * @param {pb.IBestWinners=} [properties] Properties to set
         * @returns {pb.BestWinners} BestWinners instance
         */
        ...
        /**
         * Encodes the specified BestWinners message. Does not implicitly {@link pb.BestWinners.verify|verify} messages.
         * @function encode
         * @memberof pb.BestWinners
         * @static
         * @param {pb.IBestWinners} message BestWinners message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified BestWinners message, length delimited. Does not implicitly {@link pb.BestWinners.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pb.BestWinners
         * @static
         * @param {pb.IBestWinners} message BestWinners message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pb.BestWinners} BestWinners
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        BestWinners.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.BestWinners();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        BestWinners.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.BestWinners)
                return object;
            var message = new $root.pb.BestWinners();
            if (object.Avatar != null)
                message.Avatar = String(object.Avatar);
            if (object.Sex != null)
         ...
         * @memberof pb.BestWinners
         * @static
         * @param {pb.BestWinners} message BestWinners
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    pb.HorseMsgTableStatusResp = (function() {

        /**
         * Properties of a HorseMsgTableStatusResp.
         * @memberof pb
         * @interface IHorseMsgTableStatusResp
         * @property {number|null} [PlayersCount] HorseMsgTableStatusResp PlayersCount
         * @property {pb.IGameUser|null} [User] HorseMsgTableStatusResp User
         * @property {pb.GameStatus|null} [Status] HorseMsgTableStatusResp Status
         * @property {number|null} [TimeLeft] HorseMsgTableStatusResp TimeLeft
         * @property {Array.<number|Long>|null} [TotalBet] HorseMsgTableStatusResp TotalBet
         * @property {Array.<pb.IArrayUInt32>|null} [PlayerBet] HorseMsgTableStatusResp PlayerBet
         * @property {Array.<number>|null} [Multiple] HorseMsgTableStatusResp Multiple
         * @property {Array.<number>|null} [BetAmounts] HorseMsgTableStatusResp BetAmounts
         * @property {number|null} [Result] HorseMsgTableStatusResp Result
         * @property {Array.<pb.IArrayUInt32>|null} [AreaCoins] HorseMsgTableStatusResp AreaCoins
         * @property {number|null} [ProductID] HorseMsgTableStatusResp ProductID
         * @property {Array.<com.cw.chess2.platform.ICurrencyPair>|null} [Rewards] HorseMsgTableStatusResp Rewards
         * @property {Array.<number|Long>|null} [PlayerBetLimit] HorseMsgTableStatusResp PlayerBetLimit
         * @property {Array.<pb.ISeatPlayer>|null} [SeatPlayers] HorseMsgTableStatusResp SeatPlayers
         * @property {number|null} [Rebet] HorseMsgTableStatusResp Rebet
         * @property {number|Long|null} [BetMin] HorseMsgTableStatusResp BetMin
         * @property {number|Long|null} [Rount] HorseMsgTableStatusResp Rount
         * @property {number|Long|null} [TodayWon] HorseMsgTableStatusResp TodayWon
         * @property {Array.<number>|null} [LastMultiple] HorseMsgTableStatusResp LastMultiple
         * @property {number|Long|null} [Winners] HorseMsgTableStatusResp Winners
         * @property {number|Long|null} [TotalWinnings] HorseMsgTableStatusResp TotalWinnings
         * @property {number|Long|null} [FinalSettle] HorseMsgTableStatusResp FinalSettle
         * @property {Array.<number>|null} [NewBetAmounts] HorseMsgTableStatusResp NewBetAmounts
         * @property {Array.<number>|null} [BetAmountsLevel] HorseMsgTableStatusResp BetAmountsLevel
         */

        /**
         * Constructs a new HorseMsgTableStatusResp.
         * @memberof pb
         * @classdesc Represents a HorseMsgTableStatusResp.
         * @implements IHorseMsgTableStatusResp
         * @constructor
         * @param {pb.IHorseMsgTableStatusResp=} [properties] Properties to set
         */
        function HorseMsgTableStatusResp(properties) {
            this.TotalBet = [];
            this.PlayerBet = [];
            this.Multiple = [];
            this.BetAmounts = [];
        ...
        /**
         * HorseMsgTableStatusResp PlayersCount.
         * @member {number} PlayersCount
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.PlayersCount = 0;

        /**
         * HorseMsgTableStatusResp User.
         * @member {pb.IGameUser|null|undefined} User
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.User = null;

        /**
         * HorseMsgTableStatusResp Status.
         * @member {pb.GameStatus} Status
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Status = 0;

        /**
         * HorseMsgTableStatusResp TimeLeft.
         * @member {number} TimeLeft
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.TimeLeft = 0;

        /**
         * HorseMsgTableStatusResp TotalBet.
         * @member {Array.<number|Long>} TotalBet
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.TotalBet = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp PlayerBet.
         * @member {Array.<pb.IArrayUInt32>} PlayerBet
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.PlayerBet = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp Multiple.
         * @member {Array.<number>} Multiple
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Multiple = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp BetAmounts.
         * @member {Array.<number>} BetAmounts
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.BetAmounts = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp Result.
         * @member {number} Result
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Result = 0;

        /**
         * HorseMsgTableStatusResp AreaCoins.
         * @member {Array.<pb.IArrayUInt32>} AreaCoins
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.AreaCoins = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp ProductID.
         * @member {number} ProductID
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.ProductID = 0;

        /**
         * HorseMsgTableStatusResp Rewards.
         * @member {Array.<com.cw.chess2.platform.ICurrencyPair>} Rewards
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Rewards = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp PlayerBetLimit.
         * @member {Array.<number|Long>} PlayerBetLimit
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.PlayerBetLimit = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp SeatPlayers.
         * @member {Array.<pb.ISeatPlayer>} SeatPlayers
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.SeatPlayers = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp Rebet.
         * @member {number} Rebet
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Rebet = 0;

        /**
         * HorseMsgTableStatusResp BetMin.
         * @member {number|Long} BetMin
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.BetMin = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp Rount.
         * @member {number|Long} Rount
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Rount = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp TodayWon.
         * @member {number|Long} TodayWon
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.TodayWon = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp LastMultiple.
         * @member {Array.<number>} LastMultiple
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.LastMultiple = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp Winners.
         * @member {number|Long} Winners
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.Winners = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp TotalWinnings.
         * @member {number|Long} TotalWinnings
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.TotalWinnings = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp FinalSettle.
         * @member {number|Long} FinalSettle
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.FinalSettle = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgTableStatusResp NewBetAmounts.
         * @member {Array.<number>} NewBetAmounts
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.NewBetAmounts = $util.emptyArray;

        /**
         * HorseMsgTableStatusResp BetAmountsLevel.
         * @member {Array.<number>} BetAmountsLevel
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         */
        HorseMsgTableStatusResp.prototype.BetAmountsLevel = $util.emptyArray;

        /**
         * Creates a new HorseMsgTableStatusResp instance using the specified properties.
         * @function create
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {pb.IHorseMsgTableStatusResp=} [properties] Properties to set
         * @returns {pb.HorseMsgTableStatusResp} HorseMsgTableStatusResp instance
         */
        HorseMsgTableStatusResp.create = function create(properties) {
            return new HorseMsgTableStatusResp(properties);
        };

        /**
         * Encodes the specified HorseMsgTableStatusResp message. Does not implicitly {@link pb.HorseMsgTableStatusResp.verify|verify} messages.
         * @function encode
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {pb.IHorseMsgTableStatusResp} message HorseMsgTableStatusResp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgTableStatusResp.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.PlayerBet != null && message.PlayerBet.length)
                for (var i = 0; i < message.PlayerBet.length; ++i)
                    $root.pb.ArrayUInt32.encode(message.PlayerBet[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            ...
            if (message.Result != null && Object.hasOwnProperty.call(message, "Result"))
                writer.uint32(/* id 9, wireType 0 =*/72).uint32(message.Result);
            if (message.AreaCoins != null && message.AreaCoins.length)
                for (var i = 0; i < message.AreaCoins.length; ++i)
                    $root.pb.ArrayUInt32.encode(message.AreaCoins[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            if (message.ProductID != null && Object.hasOwnProperty.call(message, "ProductID"))
                writer.uint32(/* id 11, wireType 0 =*/88).uint32(message.ProductID);
            if (message.Rewards != null && message.Rewards.length)
                for (var i = 0; i < message.Rewards.length; ++i)
                    $root.com.cw.chess2.platform.CurrencyPair.encode(message.Rewards[i], writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            ...
            if (message.SeatPlayers != null && message.SeatPlayers.length)
                for (var i = 0; i < message.SeatPlayers.length; ++i)
                    $root.pb.SeatPlayer.encode(message.SeatPlayers[i], writer.uint32(/* id 14, wireType 2 =*/114).fork()).ldelim();
            if (message.Rebet != null && Object.hasOwnProperty.call(message, "Rebet"))
                writer.uint32(/* id 15, wireType 0 =*/120).uint32(message.Rebet);
            if (message.BetMin != null && Object.hasOwnProperty.call(message, "BetMin"))
                writer.uint32(/* id 16, wireType 0 =*/128).int64(message.BetMin);
            if (message.Rount != null && Object.hasOwnProperty.call(message, "Rount"))
                writer.uint32(/* id 17, wireType 0 =*/136).int64(message.Rount);
            if (message.TodayWon != null && Object.hasOwnProperty.call(message, "TodayWon"))
                writer.uint32(/* id 18, wireType 0 =*/144).int64(message.TodayWon);
            if (message.LastMultiple != null && message.LastMultiple.length) {
                writer.uint32(/* id 19, wireType 2 =*/154).fork();
                for (var i = 0; i < message.LastMultiple.length; ++i)
                    writer.uint32(message.LastMultiple[i]);
                writer.ldelim();
            }
            if (message.Winners != null && Object.hasOwnProperty.call(message, "Winners"))
                writer.uint32(/* id 20, wireType 0 =*/160).int64(message.Winners);
            if (message.TotalWinnings != null && Object.hasOwnProperty.call(message, "TotalWinnings"))
                writer.uint32(/* id 21, wireType 0 =*/168).int64(message.TotalWinnings);
            if (message.FinalSettle != null && Object.hasOwnProperty.call(message, "FinalSettle"))
                writer.uint32(/* id 22, wireType 0 =*/176).int64(message.FinalSettle);
        ...
        /**
         * Encodes the specified HorseMsgTableStatusResp message, length delimited. Does not implicitly {@link pb.HorseMsgTableStatusResp.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {pb.IHorseMsgTableStatusResp} message HorseMsgTableStatusResp message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgTableStatusResp.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a HorseMsgTableStatusResp message from the specified reader or buffer.
         * @function decode
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pb.HorseMsgTableStatusResp} HorseMsgTableStatusResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgTableStatusResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.HorseMsgTableStatusResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 16:
                    ...
                    break;
                case 17:
                    message.Rount = reader.int64();
                    break;
                case 18:
                    message.TodayWon = reader.int64();
                    break;
                case 19:
                    if (!(message.LastMultiple && message.LastMultiple.length))
                        message.LastMultiple = [];
                    if ((tag & 7) === 2) {
                        var end2 = reader.uint32() + reader.pos;
                        while (reader.pos < end2)
                            message.LastMultiple.push(reader.uint32());
                    } else
                        message.LastMultiple.push(reader.uint32());
                    break;
                case 20:
                    message.Winners = reader.int64();
                    break;
                case 21:
                    message.TotalWinnings = reader.int64();
                    break;
                case 22:
                    message.FinalSettle = reader.int64();
                    break;
                case 23:
        ...
        /**
         * Decodes a HorseMsgTableStatusResp message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgTableStatusResp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a HorseMsgTableStatusResp message.
         * @function verify
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        HorseMsgTableStatusResp.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            ...
            if (message.Rount != null && message.hasOwnProperty("Rount"))
                if (!$util.isInteger(message.Rount) && !(message.Rount && $util.isInteger(message.Rount.low) && $util.isInteger(message.Rount.high)))
                    return "Rount: integer|Long expected";
            if (message.TodayWon != null && message.hasOwnProperty("TodayWon"))
                if (!$util.isInteger(message.TodayWon) && !(message.TodayWon && $util.isInteger(message.TodayWon.low) && $util.isInteger(message.TodayWon.high)))
                    return "TodayWon: integer|Long expected";
            if (message.LastMultiple != null && message.hasOwnProperty("LastMultiple")) {
                if (!Array.isArray(message.LastMultiple))
                    return "LastMultiple: array expected";
                for (var i = 0; i < message.LastMultiple.length; ++i)
                    if (!$util.isInteger(message.LastMultiple[i]))
                        return "LastMultiple: integer[] expected";
            }
            if (message.Winners != null && message.hasOwnProperty("Winners"))
                if (!$util.isInteger(message.Winners) && !(message.Winners && $util.isInteger(message.Winners.low) && $util.isInteger(message.Winners.high)))
                    return "Winners: integer|Long expected";
            if (message.TotalWinnings != null && message.hasOwnProperty("TotalWinnings"))
                if (!$util.isInteger(message.TotalWinnings) && !(message.TotalWinnings && $util.isInteger(message.TotalWinnings.low) && $util.isInteger(message.TotalWinnings.high)))
                    return "TotalWinnings: integer|Long expected";
            if (message.FinalSettle != null && message.hasOwnProperty("FinalSettle"))
                if (!$util.isInteger(message.FinalSettle) && !(message.FinalSettle && $util.isInteger(message.FinalSettle.low) && $util.isInteger(message.FinalSettle.high)))
                    return "FinalSettle: integer|Long expected";
        ...
        /**
         * Creates a HorseMsgTableStatusResp message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {pb.HorseMsgTableStatusResp} HorseMsgTableStatusResp
         */
        HorseMsgTableStatusResp.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.HorseMsgTableStatusResp)
                return object;
            var message = new $root.pb.HorseMsgTableStatusResp();
            if (object.PlayersCount != null)
                message.PlayersCount = object.PlayersCount >>> 0;
            if (object.User != null) {
                if (typeof object.User !== "object")
                    throw TypeError(".pb.HorseMsgTableStatusResp.User: object expected");
            ...
            if (object.TotalBet) {
                if (!Array.isArray(object.TotalBet))
                    throw TypeError(".pb.HorseMsgTableStatusResp.TotalBet: array expected");
                message.TotalBet = [];
                for (var i = 0; i < object.TotalBet.length; ++i)
                    if ($util.Long)
                        (message.TotalBet[i] = $util.Long.fromValue(object.TotalBet[i])).unsigned = false;
            ...
            if (object.PlayerBet) {
                if (!Array.isArray(object.PlayerBet))
                    throw TypeError(".pb.HorseMsgTableStatusResp.PlayerBet: array expected");
                message.PlayerBet = [];
                for (var i = 0; i < object.PlayerBet.length; ++i) {
                    if (typeof object.PlayerBet[i] !== "object")
                        throw TypeError(".pb.HorseMsgTableStatusResp.PlayerBet: object expected");
                    message.PlayerBet[i] = $root.pb.ArrayUInt32.fromObject(object.PlayerBet[i]);
                }
            }
            if (object.Multiple) {
                if (!Array.isArray(object.Multiple))
                    throw TypeError(".pb.HorseMsgTableStatusResp.Multiple: array expected");
                message.Multiple = [];
            ...
            if (object.BetAmounts) {
                if (!Array.isArray(object.BetAmounts))
                    throw TypeError(".pb.HorseMsgTableStatusResp.BetAmounts: array expected");
                message.BetAmounts = [];
            ...
            if (object.AreaCoins) {
                if (!Array.isArray(object.AreaCoins))
                    throw TypeError(".pb.HorseMsgTableStatusResp.AreaCoins: array expected");
                message.AreaCoins = [];
                for (var i = 0; i < object.AreaCoins.length; ++i) {
                    if (typeof object.AreaCoins[i] !== "object")
                        throw TypeError(".pb.HorseMsgTableStatusResp.AreaCoins: object expected");
                    message.AreaCoins[i] = $root.pb.ArrayUInt32.fromObject(object.AreaCoins[i]);
                }
            }
            if (object.ProductID != null)
            ...
            if (object.Rewards) {
                if (!Array.isArray(object.Rewards))
                    throw TypeError(".pb.HorseMsgTableStatusResp.Rewards: array expected");
                message.Rewards = [];
                for (var i = 0; i < object.Rewards.length; ++i) {
                    if (typeof object.Rewards[i] !== "object")
                        throw TypeError(".pb.HorseMsgTableStatusResp.Rewards: object expected");
                    message.Rewards[i] = $root.com.cw.chess2.platform.CurrencyPair.fromObject(object.Rewards[i]);
                }
            }
            if (object.PlayerBetLimit) {
                if (!Array.isArray(object.PlayerBetLimit))
                    throw TypeError(".pb.HorseMsgTableStatusResp.PlayerBetLimit: array expected");
                message.PlayerBetLimit = [];
            ...
            if (object.SeatPlayers) {
                if (!Array.isArray(object.SeatPlayers))
                    throw TypeError(".pb.HorseMsgTableStatusResp.SeatPlayers: array expected");
                message.SeatPlayers = [];
                for (var i = 0; i < object.SeatPlayers.length; ++i) {
                    if (typeof object.SeatPlayers[i] !== "object")
                        throw TypeError(".pb.HorseMsgTableStatusResp.SeatPlayers: object expected");
            ...
            if (object.Rount != null)
                if ($util.Long)
                    (message.Rount = $util.Long.fromValue(object.Rount)).unsigned = false;
                else if (typeof object.Rount === "string")
                    message.Rount = parseInt(object.Rount, 10);
                else if (typeof object.Rount === "number")
                    message.Rount = object.Rount;
                else if (typeof object.Rount === "object")
                    message.Rount = new $util.LongBits(object.Rount.low >>> 0, object.Rount.high >>> 0).toNumber();
            if (object.TodayWon != null)
                if ($util.Long)
                    (message.TodayWon = $util.Long.fromValue(object.TodayWon)).unsigned = false;
                else if (typeof object.TodayWon === "string")
                    message.TodayWon = parseInt(object.TodayWon, 10);
                else if (typeof object.TodayWon === "number")
                    message.TodayWon = object.TodayWon;
                else if (typeof object.TodayWon === "object")
                    message.TodayWon = new $util.LongBits(object.TodayWon.low >>> 0, object.TodayWon.high >>> 0).toNumber();
            if (object.LastMultiple) {
                if (!Array.isArray(object.LastMultiple))
                    throw TypeError(".pb.HorseMsgTableStatusResp.LastMultiple: array expected");
                message.LastMultiple = [];
                for (var i = 0; i < object.LastMultiple.length; ++i)
                    message.LastMultiple[i] = object.LastMultiple[i] >>> 0;
            }
            if (object.Winners != null)
                if ($util.Long)
                    (message.Winners = $util.Long.fromValue(object.Winners)).unsigned = false;
                else if (typeof object.Winners === "string")
                    message.Winners = parseInt(object.Winners, 10);
                else if (typeof object.Winners === "number")
                    message.Winners = object.Winners;
                else if (typeof object.Winners === "object")
                    message.Winners = new $util.LongBits(object.Winners.low >>> 0, object.Winners.high >>> 0).toNumber();
            if (object.TotalWinnings != null)
                if ($util.Long)
                    (message.TotalWinnings = $util.Long.fromValue(object.TotalWinnings)).unsigned = false;
                else if (typeof object.TotalWinnings === "string")
                    message.TotalWinnings = parseInt(object.TotalWinnings, 10);
                else if (typeof object.TotalWinnings === "number")
                    message.TotalWinnings = object.TotalWinnings;
                else if (typeof object.TotalWinnings === "object")
                    message.TotalWinnings = new $util.LongBits(object.TotalWinnings.low >>> 0, object.TotalWinnings.high >>> 0).toNumber();
            if (object.FinalSettle != null)
                if ($util.Long)
                    (message.FinalSettle = $util.Long.fromValue(object.FinalSettle)).unsigned = false;
                else if (typeof object.FinalSettle === "string")
                    message.FinalSettle = parseInt(object.FinalSettle, 10);
                else if (typeof object.FinalSettle === "number")
                    message.FinalSettle = object.FinalSettle;
                else if (typeof object.FinalSettle === "object")
                    message.FinalSettle = new $util.LongBits(object.FinalSettle.low >>> 0, object.FinalSettle.high >>> 0).toNumber();
            if (object.NewBetAmounts) {
                if (!Array.isArray(object.NewBetAmounts))
                    throw TypeError(".pb.HorseMsgTableStatusResp.NewBetAmounts: array expected");
                message.NewBetAmounts = [];
            ...
            if (object.BetAmountsLevel) {
                if (!Array.isArray(object.BetAmountsLevel))
                    throw TypeError(".pb.HorseMsgTableStatusResp.BetAmountsLevel: array expected");
                message.BetAmountsLevel = [];
        ...
        /**
         * Creates a plain object from a HorseMsgTableStatusResp message. Also converts values to other types if specified.
         * @function toObject
         * @memberof pb.HorseMsgTableStatusResp
         * @static
         * @param {pb.HorseMsgTableStatusResp} message HorseMsgTableStatusResp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        HorseMsgTableStatusResp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.Rount = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.Rount = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.TodayWon = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.TodayWon = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.Winners = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.Winners = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.TotalWinnings = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.TotalWinnings = options.longs === String ? "0" : 0;
                if ($util.Long) {
                    var long = new $util.Long(0, 0, false);
                    object.FinalSettle = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.FinalSettle = options.longs === String ? "0" : 0;
            }
            if (message.PlayersCount != null && message.hasOwnProperty("PlayersCount"))
            ...
            if (message.Rount != null && message.hasOwnProperty("Rount"))
                if (typeof message.Rount === "number")
                    object.Rount = options.longs === String ? String(message.Rount) : message.Rount;
                else
                    object.Rount = options.longs === String ? $util.Long.prototype.toString.call(message.Rount) : options.longs === Number ? new $util.LongBits(message.Rount.low >>> 0, message.Rount.high >>> 0).toNumber() : message.Rount;
            if (message.TodayWon != null && message.hasOwnProperty("TodayWon"))
                if (typeof message.TodayWon === "number")
                    object.TodayWon = options.longs === String ? String(message.TodayWon) : message.TodayWon;
                else
                    object.TodayWon = options.longs === String ? $util.Long.prototype.toString.call(message.TodayWon) : options.longs === Number ? new $util.LongBits(message.TodayWon.low >>> 0, message.TodayWon.high >>> 0).toNumber() : message.TodayWon;
            if (message.LastMultiple && message.LastMultiple.length) {
                object.LastMultiple = [];
                for (var j = 0; j < message.LastMultiple.length; ++j)
                    object.LastMultiple[j] = message.LastMultiple[j];
            }
            if (message.Winners != null && message.hasOwnProperty("Winners"))
                if (typeof message.Winners === "number")
                    object.Winners = options.longs === String ? String(message.Winners) : message.Winners;
                else
                    object.Winners = options.longs === String ? $util.Long.prototype.toString.call(message.Winners) : options.longs === Number ? new $util.LongBits(message.Winners.low >>> 0, message.Winners.high >>> 0).toNumber() : message.Winners;
            if (message.TotalWinnings != null && message.hasOwnProperty("TotalWinnings"))
                if (typeof message.TotalWinnings === "number")
                    object.TotalWinnings = options.longs === String ? String(message.TotalWinnings) : message.TotalWinnings;
                else
                    object.TotalWinnings = options.longs === String ? $util.Long.prototype.toString.call(message.TotalWinnings) : options.longs === Number ? new $util.LongBits(message.TotalWinnings.low >>> 0, message.TotalWinnings.high >>> 0).toNumber() : message.TotalWinnings;
            if (message.FinalSettle != null && message.hasOwnProperty("FinalSettle"))
                if (typeof message.FinalSettle === "number")
                    object.FinalSettle = options.longs === String ? String(message.FinalSettle) : message.FinalSettle;
                else
                    object.FinalSettle = options.longs === String ? $util.Long.prototype.toString.call(message.FinalSettle) : options.longs === Number ? new $util.LongBits(message.FinalSettle.low >>> 0, message.FinalSettle.high >>> 0).toNumber() : message.FinalSettle;
            if (message.NewBetAmounts && message.NewBetAmounts.length) {
                object.NewBetAmounts = [];
        ...
        /**
         * Converts this HorseMsgTableStatusResp to JSON.
         * @function toJSON
         * @memberof pb.HorseMsgTableStatusResp
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        HorseMsgTableStatusResp.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return HorseMsgTableStatusResp;
    })();

    pb.HorseMsgGameStartResp = (function() {

        /**
         * Properties of a HorseMsgGameStartResp.
         * @memberof pb
         * @interface IHorseMsgGameStartResp
         * @property {number|null} [TimeLeft] HorseMsgGameStartResp TimeLeft
         * @property {Array.<number>|null} [Multiple] HorseMsgGameStartResp Multiple
         * @property {number|Long|null} [Rount] HorseMsgGameStartResp Rount
         */

        /**
         * Constructs a new HorseMsgGameStartResp.
         * @memberof pb
         * @classdesc Represents a HorseMsgGameStartResp.
         * @implements IHorseMsgGameStartResp
         * @constructor
         * @param {pb.IHorseMsgGameStartResp=} [properties] Properties to set
         */
        function HorseMsgGameStartResp(properties) {
            this.Multiple = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * HorseMsgGameStartResp TimeLeft.
         * @member {number} TimeLeft
         * @memberof pb.HorseMsgGameStartResp
         * @instance
         */
        HorseMsgGameStartResp.prototype.TimeLeft = 0;

        /**
         * HorseMsgGameStartResp Multiple.
         * @member {Array.<number>} Multiple
         * @memberof pb.HorseMsgGameStartResp
         * @instance
         */
        HorseMsgGameStartResp.prototype.Multiple = $util.emptyArray;

        /**
         * HorseMsgGameStartResp Rount.
         * @member {number|Long} Rount
         * @memberof pb.HorseMsgGameStartResp
         * @instance
         */
        HorseMsgGameStartResp.prototype.Rount = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * Creates a new HorseMsgGameStartResp instance using the specified properties.
         * @function create
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {pb.IHorseMsgGameStartResp=} [properties] Properties to set
         * @returns {pb.HorseMsgGameStartResp} HorseMsgGameStartResp instance
         */
        HorseMsgGameStartResp.create = function create(properties) {
            return new HorseMsgGameStartResp(properties);
        };

        /**
         * Encodes the specified HorseMsgGameStartResp message. Does not implicitly {@link pb.HorseMsgGameStartResp.verify|verify} messages.
         * @function encode
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {pb.IHorseMsgGameStartResp} message HorseMsgGameStartResp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgGameStartResp.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.TimeLeft != null && Object.hasOwnProperty.call(message, "TimeLeft"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.TimeLeft);
            ...
            if (message.Rount != null && Object.hasOwnProperty.call(message, "Rount"))
                writer.uint32(/* id 3, wireType 0 =*/24).int64(message.Rount);
            return writer;
        };

        /**
         * Encodes the specified HorseMsgGameStartResp message, length delimited. Does not implicitly {@link pb.HorseMsgGameStartResp.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {pb.IHorseMsgGameStartResp} message HorseMsgGameStartResp message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgGameStartResp.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a HorseMsgGameStartResp message from the specified reader or buffer.
         * @function decode
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pb.HorseMsgGameStartResp} HorseMsgGameStartResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgGameStartResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.HorseMsgGameStartResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a HorseMsgGameStartResp message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgGameStartResp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a HorseMsgGameStartResp message.
         * @function verify
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        HorseMsgGameStartResp.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.TimeLeft != null && message.hasOwnProperty("TimeLeft"))
                if (!$util.isInteger(message.TimeLeft))
        ...
        /**
         * Creates a HorseMsgGameStartResp message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {pb.HorseMsgGameStartResp} HorseMsgGameStartResp
         */
        HorseMsgGameStartResp.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.HorseMsgGameStartResp)
                return object;
            var message = new $root.pb.HorseMsgGameStartResp();
            if (object.TimeLeft != null)
                message.TimeLeft = object.TimeLeft >>> 0;
            if (object.Multiple) {
                if (!Array.isArray(object.Multiple))
                    throw TypeError(".pb.HorseMsgGameStartResp.Multiple: array expected");
                message.Multiple = [];
                for (var i = 0; i < object.Multiple.length; ++i)
                    message.Multiple[i] = object.Multiple[i] >>> 0;
            }
        ...
        /**
         * Creates a plain object from a HorseMsgGameStartResp message. Also converts values to other types if specified.
         * @function toObject
         * @memberof pb.HorseMsgGameStartResp
         * @static
         * @param {pb.HorseMsgGameStartResp} message HorseMsgGameStartResp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        HorseMsgGameStartResp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
        ...
        /**
         * Converts this HorseMsgGameStartResp to JSON.
         * @function toJSON
         * @memberof pb.HorseMsgGameStartResp
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        HorseMsgGameStartResp.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return HorseMsgGameStartResp;
    })();

    pb.HorseMsgGameSettleResp = (function() {

        /**
         * Properties of a HorseMsgGameSettleResp.
         * @memberof pb
         * @interface IHorseMsgGameSettleResp
         * @property {number|null} [TimeLeft] HorseMsgGameSettleResp TimeLeft
         * @property {number|null} [Result] HorseMsgGameSettleResp Result
         * @property {number|Long|null} [SettleAmount] HorseMsgGameSettleResp SettleAmount
         * @property {Array.<pb.ISeatSettles>|null} [SeatSettles] HorseMsgGameSettleResp SeatSettles
         * @property {Array.<number>|null} [Multiple] HorseMsgGameSettleResp Multiple
         * @property {Array.<number>|null} [Randoms] HorseMsgGameSettleResp Randoms
         * @property {number|Long|null} [Winners] HorseMsgGameSettleResp Winners
         * @property {number|Long|null} [TotalWinnings] HorseMsgGameSettleResp TotalWinnings
         * @property {number|Long|null} [FinalSettle] HorseMsgGameSettleResp FinalSettle
         * @property {number|Long|null} [TodayWon] HorseMsgGameSettleResp TodayWon
         * @property {Array.<pb.IBestWinners>|null} [BestWinners] HorseMsgGameSettleResp BestWinners
         */

        /**
         * Constructs a new HorseMsgGameSettleResp.
         * @memberof pb
         * @classdesc Represents a HorseMsgGameSettleResp.
         * @implements IHorseMsgGameSettleResp
         * @constructor
         * @param {pb.IHorseMsgGameSettleResp=} [properties] Properties to set
         */
        function HorseMsgGameSettleResp(properties) {
            this.SeatSettles = [];
            this.Multiple = [];
            this.Randoms = [];
            this.BestWinners = [];
        ...
        /**
         * HorseMsgGameSettleResp TimeLeft.
         * @member {number} TimeLeft
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.TimeLeft = 0;

        /**
         * HorseMsgGameSettleResp Result.
         * @member {number} Result
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.Result = 0;

        /**
         * HorseMsgGameSettleResp SettleAmount.
         * @member {number|Long} SettleAmount
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.SettleAmount = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgGameSettleResp SeatSettles.
         * @member {Array.<pb.ISeatSettles>} SeatSettles
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.SeatSettles = $util.emptyArray;

        /**
         * HorseMsgGameSettleResp Multiple.
         * @member {Array.<number>} Multiple
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.Multiple = $util.emptyArray;

        /**
         * HorseMsgGameSettleResp Randoms.
         * @member {Array.<number>} Randoms
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.Randoms = $util.emptyArray;

        /**
         * HorseMsgGameSettleResp Winners.
         * @member {number|Long} Winners
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.Winners = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgGameSettleResp TotalWinnings.
         * @member {number|Long} TotalWinnings
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.TotalWinnings = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgGameSettleResp FinalSettle.
         * @member {number|Long} FinalSettle
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.FinalSettle = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgGameSettleResp TodayWon.
         * @member {number|Long} TodayWon
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.TodayWon = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * HorseMsgGameSettleResp BestWinners.
         * @member {Array.<pb.IBestWinners>} BestWinners
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         */
        HorseMsgGameSettleResp.prototype.BestWinners = $util.emptyArray;

        /**
         * Creates a new HorseMsgGameSettleResp instance using the specified properties.
         * @function create
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {pb.IHorseMsgGameSettleResp=} [properties] Properties to set
         * @returns {pb.HorseMsgGameSettleResp} HorseMsgGameSettleResp instance
         */
        HorseMsgGameSettleResp.create = function create(properties) {
            return new HorseMsgGameSettleResp(properties);
        };

        /**
         * Encodes the specified HorseMsgGameSettleResp message. Does not implicitly {@link pb.HorseMsgGameSettleResp.verify|verify} messages.
         * @function encode
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {pb.IHorseMsgGameSettleResp} message HorseMsgGameSettleResp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgGameSettleResp.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.TimeLeft != null && Object.hasOwnProperty.call(message, "TimeLeft"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.TimeLeft);
            ...
            if (message.SettleAmount != null && Object.hasOwnProperty.call(message, "SettleAmount"))
                writer.uint32(/* id 3, wireType 0 =*/24).int64(message.SettleAmount);
            if (message.SeatSettles != null && message.SeatSettles.length)
                for (var i = 0; i < message.SeatSettles.length; ++i)
                    $root.pb.SeatSettles.encode(message.SeatSettles[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.Multiple != null && message.Multiple.length) {
                writer.uint32(/* id 5, wireType 2 =*/42).fork();
                for (var i = 0; i < message.Multiple.length; ++i)
                    writer.uint32(message.Multiple[i]);
            ...
            if (message.Randoms != null && message.Randoms.length) {
                writer.uint32(/* id 6, wireType 2 =*/50).fork();
                for (var i = 0; i < message.Randoms.length; ++i)
                    writer.uint32(message.Randoms[i]);
                writer.ldelim();
            }
            if (message.Winners != null && Object.hasOwnProperty.call(message, "Winners"))
                writer.uint32(/* id 7, wireType 0 =*/56).int64(message.Winners);
            if (message.TotalWinnings != null && Object.hasOwnProperty.call(message, "TotalWinnings"))
                writer.uint32(/* id 8, wireType 0 =*/64).int64(message.TotalWinnings);
            if (message.FinalSettle != null && Object.hasOwnProperty.call(message, "FinalSettle"))
                writer.uint32(/* id 9, wireType 0 =*/72).int64(message.FinalSettle);
            if (message.TodayWon != null && Object.hasOwnProperty.call(message, "TodayWon"))
                writer.uint32(/* id 10, wireType 0 =*/80).int64(message.TodayWon);
            if (message.BestWinners != null && message.BestWinners.length)
                for (var i = 0; i < message.BestWinners.length; ++i)
                    $root.pb.BestWinners.encode(message.BestWinners[i], writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified HorseMsgGameSettleResp message, length delimited. Does not implicitly {@link pb.HorseMsgGameSettleResp.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {pb.IHorseMsgGameSettleResp} message HorseMsgGameSettleResp message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgGameSettleResp.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a HorseMsgGameSettleResp message from the specified reader or buffer.
         * @function decode
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pb.HorseMsgGameSettleResp} HorseMsgGameSettleResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgGameSettleResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.HorseMsgGameSettleResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    if (!(message.Randoms && message.Randoms.length))
                        message.Randoms = [];
                    if ((tag & 7) === 2) {
                        var end2 = reader.uint32() + reader.pos;
                        while (reader.pos < end2)
                            message.Randoms.push(reader.uint32());
                    } else
                        message.Randoms.push(reader.uint32());
                    break;
                case 7:
                ...
                case 11:
                    if (!(message.BestWinners && message.BestWinners.length))
                        message.BestWinners = [];
                    message.BestWinners.push($root.pb.BestWinners.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a HorseMsgGameSettleResp message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgGameSettleResp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a HorseMsgGameSettleResp message.
         * @function verify
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        HorseMsgGameSettleResp.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.TimeLeft != null && message.hasOwnProperty("TimeLeft"))
                if (!$util.isInteger(message.TimeLeft))
            ...
            if (message.Randoms != null && message.hasOwnProperty("Randoms")) {
                if (!Array.isArray(message.Randoms))
                    return "Randoms: array expected";
                for (var i = 0; i < message.Randoms.length; ++i)
                    if (!$util.isInteger(message.Randoms[i]))
                        return "Randoms: integer[] expected";
            }
            if (message.Winners != null && message.hasOwnProperty("Winners"))
                if (!$util.isInteger(message.Winners) && !(message.Winners && $util.isInteger(message.Winners.low) && $util.isInteger(message.Winners.high)))
                    return "Winners: integer|Long expected";
            ...
            if (message.BestWinners != null && message.hasOwnProperty("BestWinners")) {
                ...
                for (var i = 0; i < message.BestWinners.length; ++i) {
                    var error = $root.pb.BestWinners.verify(message.BestWinners[i]);
                    if (error)
        ...
        /**
         * Creates a HorseMsgGameSettleResp message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {pb.HorseMsgGameSettleResp} HorseMsgGameSettleResp
         */
        HorseMsgGameSettleResp.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.HorseMsgGameSettleResp)
                return object;
            var message = new $root.pb.HorseMsgGameSettleResp();
            if (object.TimeLeft != null)
                message.TimeLeft = object.TimeLeft >>> 0;
            if (object.Result != null)
                message.Result = object.Result >>> 0;
            ...
            if (object.SeatSettles) {
                if (!Array.isArray(object.SeatSettles))
                    throw TypeError(".pb.HorseMsgGameSettleResp.SeatSettles: array expected");
                message.SeatSettles = [];
                for (var i = 0; i < object.SeatSettles.length; ++i) {
                    if (typeof object.SeatSettles[i] !== "object")
                        throw TypeError(".pb.HorseMsgGameSettleResp.SeatSettles: object expected");
                    message.SeatSettles[i] = $root.pb.SeatSettles.fromObject(object.SeatSettles[i]);
                }
            }
            if (object.Multiple) {
                if (!Array.isArray(object.Multiple))
                    throw TypeError(".pb.HorseMsgGameSettleResp.Multiple: array expected");
                message.Multiple = [];
                for (var i = 0; i < object.Multiple.length; ++i)
                    message.Multiple[i] = object.Multiple[i] >>> 0;
            }
            if (object.Randoms) {
                if (!Array.isArray(object.Randoms))
                    throw TypeError(".pb.HorseMsgGameSettleResp.Randoms: array expected");
                message.Randoms = [];
                for (var i = 0; i < object.Randoms.length; ++i)
                    message.Randoms[i] = object.Randoms[i] >>> 0;
            }
            if (object.Winners != null)
                if ($util.Long)
                    (message.Winners = $util.Long.fromValue(object.Winners)).unsigned = false;
            ...
            if (object.BestWinners) {
                if (!Array.isArray(object.BestWinners))
                    throw TypeError(".pb.HorseMsgGameSettleResp.BestWinners: array expected");
                message.BestWinners = [];
                for (var i = 0; i < object.BestWinners.length; ++i) {
                    if (typeof object.BestWinners[i] !== "object")
                        throw TypeError(".pb.HorseMsgGameSettleResp.BestWinners: object expected");
                    message.BestWinners[i] = $root.pb.BestWinners.fromObject(object.BestWinners[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a HorseMsgGameSettleResp message. Also converts values to other types if specified.
         * @function toObject
         * @memberof pb.HorseMsgGameSettleResp
         * @static
         * @param {pb.HorseMsgGameSettleResp} message HorseMsgGameSettleResp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        HorseMsgGameSettleResp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults) {
            ...
            if (message.Randoms && message.Randoms.length) {
                object.Randoms = [];
                for (var j = 0; j < message.Randoms.length; ++j)
                    object.Randoms[j] = message.Randoms[j];
            }
            if (message.Winners != null && message.hasOwnProperty("Winners"))
                if (typeof message.Winners === "number")
                    object.Winners = options.longs === String ? String(message.Winners) : message.Winners;
            ...
            if (message.BestWinners && message.BestWinners.length) {
                ...
                for (var j = 0; j < message.BestWinners.length; ++j)
                    object.BestWinners[j] = $root.pb.BestWinners.toObject(message.BestWinners[j], options);
            }
            return object;
        };

        /**
         * Converts this HorseMsgGameSettleResp to JSON.
         * @function toJSON
         * @memberof pb.HorseMsgGameSettleResp
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        HorseMsgGameSettleResp.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return HorseMsgGameSettleResp;
    })();

    pb.HorseMsgHistoryResp = (function() {

        /**
         * Properties of a HorseMsgHistoryResp.
         * @memberof pb
         * @interface IHorseMsgHistoryResp
         * @property {Array.<number>|null} [Result] HorseMsgHistoryResp Result
         */

        /**
         * Constructs a new HorseMsgHistoryResp.
         * @memberof pb
         * @classdesc Represents a HorseMsgHistoryResp.
         * @implements IHorseMsgHistoryResp
         * @constructor
         * @param {pb.IHorseMsgHistoryResp=} [properties] Properties to set
         */
        function HorseMsgHistoryResp(properties) {
            this.Result = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * HorseMsgHistoryResp Result.
         * @member {Array.<number>} Result
         * @memberof pb.HorseMsgHistoryResp
         * @instance
         */
        HorseMsgHistoryResp.prototype.Result = $util.emptyArray;

        /**
         * Creates a new HorseMsgHistoryResp instance using the specified properties.
         * @function create
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {pb.IHorseMsgHistoryResp=} [properties] Properties to set
         * @returns {pb.HorseMsgHistoryResp} HorseMsgHistoryResp instance
         */
        HorseMsgHistoryResp.create = function create(properties) {
            return new HorseMsgHistoryResp(properties);
        };

        /**
         * Encodes the specified HorseMsgHistoryResp message. Does not implicitly {@link pb.HorseMsgHistoryResp.verify|verify} messages.
         * @function encode
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {pb.IHorseMsgHistoryResp} message HorseMsgHistoryResp message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgHistoryResp.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.Result != null && message.Result.length) {
                writer.uint32(/* id 1, wireType 2 =*/10).fork();
                for (var i = 0; i < message.Result.length; ++i)
                    writer.uint32(message.Result[i]);
                writer.ldelim();
            }
            return writer;
        };
        ...
        /**
         * Encodes the specified HorseMsgHistoryResp message, length delimited. Does not implicitly {@link pb.HorseMsgHistoryResp.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {pb.IHorseMsgHistoryResp} message HorseMsgHistoryResp message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        HorseMsgHistoryResp.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a HorseMsgHistoryResp message from the specified reader or buffer.
         * @function decode
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pb.HorseMsgHistoryResp} HorseMsgHistoryResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgHistoryResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pb.HorseMsgHistoryResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    ...
                    if ((tag & 7) === 2) {
                        var end2 = reader.uint32() + reader.pos;
                        while (reader.pos < end2)
                            message.Result.push(reader.uint32());
                    } else
                        message.Result.push(reader.uint32());
                    break;
                default:
        ...
        /**
         * Decodes a HorseMsgHistoryResp message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        HorseMsgHistoryResp.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a HorseMsgHistoryResp message.
         * @function verify
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        HorseMsgHistoryResp.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.Result != null && message.hasOwnProperty("Result")) {
        ...
        /**
         * Creates a HorseMsgHistoryResp message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {pb.HorseMsgHistoryResp} HorseMsgHistoryResp
         */
        HorseMsgHistoryResp.fromObject = function fromObject(object) {
            if (object instanceof $root.pb.HorseMsgHistoryResp)
                return object;
            var message = new $root.pb.HorseMsgHistoryResp();
            if (object.Result) {
                if (!Array.isArray(object.Result))
                    throw TypeError(".pb.HorseMsgHistoryResp.Result: array expected");
                message.Result = [];
        ...
        /**
         * Creates a plain object from a HorseMsgHistoryResp message. Also converts values to other types if specified.
         * @function toObject
         * @memberof pb.HorseMsgHistoryResp
         * @static
         * @param {pb.HorseMsgHistoryResp} message HorseMsgHistoryResp
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        HorseMsgHistoryResp.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.arrays || options.defaults)
        ...
        /**
         * Converts this HorseMsgHistoryResp to JSON.
         * @function toJSON
         * @memberof pb.HorseMsgHistoryResp
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        HorseMsgHistoryResp.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return HorseMsgHistoryResp;
    })();
