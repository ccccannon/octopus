...
@ccclass
export default class MaskNodeUIAnimationCtrl extends cc.Component {

    @property(cc.Node)
    node_bet_area: cc.Node = null;
    @property(cc.Node)
    node_view_finger: cc.Node = null;
    @property(cc.Node)
    node_view_fly_screen: cc.Node = null;

    @property([cc.SpriteFrame])
    viewFlyScreenList: Array<cc.SpriteFrame> = [];

    @property(cc.Node)
    node_mask_area: cc.Node = null;


    public center: cc.Vec3 = null;
    ...
    onLoad() {
        ...
        this.center = this.node.convertToNodeSpaceAR(this.node_mask_area.convertToWorldSpaceAR(cc.v3(0, 0, 0)));
    }
    ...
    initFlyScreenPosition() {
        ...
        this.node_view_fly_screen.position = cc.v3(-(viewSize.width + this.node_view_fly_screen.width) / 2, this.center.y);
