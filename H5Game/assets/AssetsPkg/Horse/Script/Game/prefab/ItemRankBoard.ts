...
@ccclass
export default class ItemRankBoard extends cc.Component {
    ...
    @property([cc.SpriteFrame])
    viewListSex: Array<cc.SpriteFrame> = [];
    ...
    setSex(num) {
        ...
        //     return;
        // }
        this.sprite_sex.spriteFrame = this.viewListSex[num];
    ...
    setRank(num) {
        ...
        if (num > TOP.THREE) {
            ...
            this.sprite_rank.spriteFrame = this.viewListRank[num - 1];
            // if (num == TOP.ONE) {
