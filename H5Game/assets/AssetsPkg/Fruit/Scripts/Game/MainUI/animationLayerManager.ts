...
@ccclass
export default class animationLayerManager extends cc.Component {
    @property(cc.Prefab)
    ...
    addAnimationListener() {
        ...
        // cc.systemEvent.on('userAvatarFly', this.avatarAnimation, this);
        ...
        try {
            ...
            const img = () => {
                return new Promise((res) => {
                    setTimeout(() => {
                        res(this.spriteAtlas.getSpriteFrame('view_user_avatar_default'));
                    }, 300)
                })
            }
            ...
            console.log(err);
            sf = this.spriteAtlas.getSpriteFrame('view_user_avatar_default');
        }
